          ...
          {linkDialogState.type === 'preview' && (
            <>
              ...
              >
                ...
                {urlIsExternal && <EditorIcon name="external" />}
              </a>
              ...
              <Tooltip.Provider>
                <Tooltip.Root open={copyUrlTooltipOpen}>
                  <Tooltip.Trigger asChild>
                    ...
                    >
                      <EditorIcon name={copyUrlTooltipOpen ? 'check' : 'copy'} />
                    </ActionButton>
                  </Tooltip.Trigger>
...
const ActionButton = React.forwardRef<HTMLButtonElement, React.ComponentPropsWithoutRef<'button'>>(({ className, ...props }, ref) => {
  return <button className={classNames(styles.linkDialogActionButton, className)} ref={ref} {...props} />
})
